...
<ComponentSignature
  signature={{
    pretext:
      'Provide either the shorthand property <code>groups</code> to set both <code>memberships</code> and <code>filter</code> to the same value or set them up individually.',
    props: [
