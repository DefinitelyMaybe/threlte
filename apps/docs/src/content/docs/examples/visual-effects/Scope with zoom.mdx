...
This example shows how to utilize the [`useFBO`](/reference/extras/visual-effects/use-fbo/) hook to create a sniper scope zoom effect, complete
...
from [`useFBO`](/reference/extras/visual-effects/use-fbo/) hook is used in the scope where a
...
[Threlte gltf CLI tool](/reference/gltf/getting-started) tool.
...
The [useFBO](/reference/extras/visual-effects/use-fbo/) hook is used to prepare a render target for the scope's view texture.
