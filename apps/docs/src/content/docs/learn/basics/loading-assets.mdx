...
[@threlte/gltf](/reference/gltf/getting-started) to generate a Svelte
component for your model. The generated component has `<T/>` components for all
of your models parts. [Adjust the component](/learn/advanced/custom-abstractions) to your liking, then
...
The Threlte docs also have an [animation example](/examples/animation/animation-transitions) to help you get
started.
...
[useTexture](/reference/extras/use-texture):
...
types (like [audio](/reference/extras/audio)), but it doesn't have
...
The [Suspense](/reference/extras/suspense) component can additionally help
