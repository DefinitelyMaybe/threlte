...
Threlte uses Svelte's [Context API](https://svelte.dev/tutorial/svelte/context-api) to share `renderer`, `camera`, [and others](/reference/core/hooks/use-threlte/#usage) to any child component.
