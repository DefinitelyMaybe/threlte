...
For more information, see the [`useGltf`](/reference/extras/content/use-gltf/) and [`GLTF`](/reference/extras/content/gltf/) docs.
...
`EffectComposer` have been removed. Threlte 6 now provides a hook called [`useRender`](https://v7.threlte.xyz/docs/reference/core/use-render) which
...
[`useFrame`](https://v7.threlte.xyz/docs/reference/core/use-frame) where the context is available as the first argument
to the callback:
...
The full type definition is [currently listed here](https://v7.threlte.xyz/docs/reference/core/use-threlte).
...
Check out the [hooks documentation](/reference/extras/content/use-gltf-animations/) for more information.
