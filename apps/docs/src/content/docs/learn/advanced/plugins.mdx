...
Plugins allow you to extend Threlte's [`<T>`](/reference/core/components/t)
...
`@threlte/extras`](/reference/extras/interaction/interactivity) is an example of what a
...
[`<T>`'s `oncreate`](/reference/core/components/t#create-event) shares some
...
This plugin outlines the basic setup of the extras [bvh plugin](/reference/extras/interaction/bvh/).
