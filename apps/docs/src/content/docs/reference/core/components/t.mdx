...
Using automatic [**attach**](/reference/core/components/t#attach), the geometry as
...
[`interactivity`](/reference/extras/interaction/interactivity) plugin.
...
Plugins](/reference/core/helpers/plugins/).
