...
In fact, the components [`<OrbitControls>`](/reference/extras/interaction/orbit-controls/) and
[`<TransformControls>`](/reference/extras/interaction/transform-controls/) from `'@threlte/extras'` use this method
