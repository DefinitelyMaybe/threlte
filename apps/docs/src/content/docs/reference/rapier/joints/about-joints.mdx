...
- **Fixed joint**
  - [`useFixedJoint` hook](/reference/rapier/joints/use-fixed-joint/)
...
- **Revolute joint**
  - [`useRevoluteJoint` hook](/reference/rapier/joints/use-revolute-joint/)
...
- **Prismatic joint**
  - [`usePrismaticJoint` hook](/reference/rapier/joints/use-prismatic-joint/)
...
- **Spherical joint**
  - [`useSphericalJoint` hook](/reference/rapier/joints/use-spherical-joint/)
