...
The hook can be used within the [`<Sheet>`](/reference/theatre/components/sheet/) context or withing the [`<Sequence>`](/reference/theatre/components/sequence) context:
