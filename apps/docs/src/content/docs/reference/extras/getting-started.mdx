...
Let's look at an example, the [`<OrbitControls>`](/reference/extras/orbit-controls). They are a common component in Three.js applications and can be used to easily manipulate the camera. Let's implement it:
...
respective `<T>` components. Check out the [guide on events](/learn/basics/events) for more
...
<Tip type="tip">
  ...
  structure](/learn/basics/context).
</Tip>
