...
[`<AudioListener>`](/reference/extras/audio/audio-listener/), [`<Audio>`](/reference/extras/audio/audio/)
and [`<PositionalAudio>`](/reference/extras/audio/positional-audio/) will create an audio context
if mounted.
