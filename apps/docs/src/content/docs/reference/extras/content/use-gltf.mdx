...
Use the component [`<GLTF>`](/reference/extras/content/gltf/) if you want to use a model in its entirety.
...
>
  On the [loading-assets](/learn/basics/loading-assets) page, Threlte provides the `@threlte/gltf`
  CLI tool that can be used to generate a reusable Svelte component for your gltf as well as its
  types.
</Tip>
