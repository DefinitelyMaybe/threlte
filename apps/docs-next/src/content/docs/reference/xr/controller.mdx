...
Two additional slots exist to place children in the controller's [grip space](https://developer.mozilla.org/en-US/docs/Web/API/XRInputSource/gripSpace) and the controller's [target ray space](https://developer.mozilla.org/en-US/docs/Web/API/XRInputSource/targetRaySpace).
