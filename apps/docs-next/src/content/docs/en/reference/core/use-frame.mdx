...
<Tip type="danger">
  This hook is deprecated and will be removed in the next major release. Please use
  [`useTask`](/docs/reference/core/use-task) instead. See the [migration
  guide](/docs/learn/advanced/migration-guides#migrating-from-useframe-and-userender-to-the-task-scheduling-system)
  for more information.
</Tip>

This hook allows you to execute code on every frame as part of the Threlte _Task Scheduling System_.
