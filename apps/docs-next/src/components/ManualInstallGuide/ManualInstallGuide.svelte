...
<div
  class="grid grid-cols-1 items-start justify-start gap-x-4 gap-y-2 pt-4 max-md:justify-items-start md:grid-cols-[auto_auto] md:gap-y-2 md:[&>button]:my-1"
>
  <InstallButton
    disabled
    active
...
<div
  class="not-prose group relative overflow-x-auto whitespace-pre-wrap rounded-md border border-white/20 bg-[#19446b4d] p-3 text-sm shadow-xl [&>*]:!bg-transparent"
>
